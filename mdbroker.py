...
class MajorDomoBroker(object):
    ...
    def process_worker(self, sender, msg):
        ...
        if (MDP.W_READY == command):
            ...
            if (worker_ready):
                ...
                client = msg.pop(0)
                empty = msg.pop(0) # ?
                msg = [client, MDP.EMPTY, MDP.C_CLIENT, worker.service.name] + msg
    ...
    def send_to_worker(self, worker, command, option, msg=None):
        ...
        if option is not None:
            msg = [option] + msg
        msg = [worker.address, MDP.EMPTY, MDP.W_WORKER, command] + msg
